...
export function ReservationsSection(): React.JSX.Element {
  ...
  return (
    <section id="reservations" aria-label="App Réservation">
      ...
      >
        <motion.div
          initial={{ opacity: 0, y: prefersReducedMotion ? 0 : 14, rotateX: prefersReducedMotion ? 0 : -5 }}
          ...
          aria-hidden
        >
          <div className="relative mx-auto max-w-2xl overflow-hidden rounded-xl border border-white/10 bg-black/40 shadow-elev-2">
